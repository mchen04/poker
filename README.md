...
- Host-controlled lobby settings for blinds, buy-in, seats, timer, straddle, chip controls, custom queue, and 7-2 bounty.
...
- Server-only shuffle/deck/private-card state with per-player private snapshots and post-hand shuffle reveal data.
